from server import get_catalog, get_dataset_sample, get_dataset_schema, run_sql_query
...
def test_prototype():
    ...
    res = run_sql_query(
        "SELECT HomeTeam, AwayTeam, FTHG, FTAG FROM bronze_football_sample WHERE FTHG > 4 LIMIT 3"
    )
    print(res)
